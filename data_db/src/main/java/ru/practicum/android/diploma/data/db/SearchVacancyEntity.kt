...
@Entity(tableName = "vacancies_table") //todo rename? + define related entity
...
// всё поля по исходному полю из ответа
    @PrimaryKey
    val code: String, //по справочнику может быть null, но т.к. это указано на всех полях - решил что они просто страхуются
