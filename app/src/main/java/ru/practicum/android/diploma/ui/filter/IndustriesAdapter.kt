...
class IndustriesAdapter(val onCLick: (Int, Industry) -> Unit): RecyclerView.Adapter<IndustryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: IndustryViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            ...
            onCLick.invoke(checkedRadioButtonId, data[checkedRadioButtonId])
